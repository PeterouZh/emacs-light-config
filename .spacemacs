...
;;;************************************************************
  ...
  ;; stay in current file when closing a term
  (setq multi-term-switch-after-close nil)
  (global-set-key (kbd "<f4>") 'multi-term-dedicated-open)
  ;; focus on opened dedicated term
  (setq multi-term-dedicated-select-after-open-p t)
;;;************************************************************
  ;; neotree
  (global-set-key (kbd "<f2>") 'neotree-find-project-root)
;;;************************************************************
  ;; Copy and paste to DISPLAY
...
;;;************************************************************
  ...
  ;; shift + left-mouse-click : select region and paste
  (global-set-key (kbd "<S-down-mouse-1>") 'mouse-save-then-kill)
;;;************************************************************
  ;; if want to copy text in terminal, disable this
  (xterm-mouse-mode t)
;;;************************************************************
